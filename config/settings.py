...
class Settings(BaseSettings):
    ...
    # Parallel evaluation (CPU worker processes)
    optimizer_workers: int = max(1, multiprocessing.cpu_count() - 1)

    # Logging
    ada_agent_log_level: str = "INFO"
    log_progress_bars: bool = True
    log_feature_builds: bool = False
...
class SettingsManager:
    ...
    def save_to_env(settings_dict: dict):
        ...
        with open(env_path, 'w') as f:
            f.write("# ADA Seller-Exhaustion Backtesting Tool\n")
